 ...
 */
public class Mamut extends Item{
...
public Mamut(int x, int y, int width, int height, Game game) {
        super(x, y);
        this.width = width;
        this.height = height;
        this.game = game;
 //       this.Alien = new Animation(Assets.AlienImages, 100);
        this.leftAnimation = new Animation(Assets.hogWhiteLeft, 100);
        this.rightAnimation = new Animation(Assets.hogWhiteRight, 100);
        this.alive = true;
        this.direction = 7;
        this.initialX = x;
        this.initialY = y;
