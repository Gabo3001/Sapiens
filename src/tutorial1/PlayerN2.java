 ...
 * @author HOME
 */
public class PlayerN2 extends Item {
    ...
    private Animation animationLeft2;
    private boolean launch; 

    public PlayerN2(int x, int y, int direction, int width, int height, Game game) {
        super(x, y);
        ...
        this.animationLeft = new Animation(Assets.playerRight2, 100);
        this.animationLeft2 = new Animation(Assets.playerLeft, 100);
        this.launch = false;
    }
    ...
    public void render(Graphics g) {
        ...
        } else if (game.getKeyManager().left && !game.isPause() && !isLaunch()) {
            g.drawImage(animationLeft.getCurretFrame(), getX(), getY(), getHeight(), getWidth(), null);
        } else if (game.getKeyManager().left && !game.isPause() && isLaunch()) {
            g.drawImage(animationLeft2.getCurretFrame(), getX(), getY(), getHeight(), getWidth(), null);
        } else if (!isLaunch()){
            g.drawImage(Assets.playerLevel2, getX(), getY(), getHeight(), getWidth(), null);
        } else {
