 ...
 */
public class MamutNegro extends Item{
...
public MamutNegro(int x, int y, int width, int height, Game game, int direction) {
        super(x, y);
        this.width = width;
        this.height = height;
        this.game = game;
 //       this.Alien = new Animation(Assets.AlienImages, 100);
        this.leftAnimation = new Animation(Assets.hogBlackLeft, 100);
        this.rightAnimation = new Animation(Assets.hogBlackRight, 100);
        this.alive = true;
